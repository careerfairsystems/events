...
/**
  ...
  */
exports.offerSpot = function (reservation, res){
  ...
  sendMail(reservation, template, content, subject, res);
};
...
exports.confirmationMail = function (reservationId, res) {
  ...
  Reservation.findById(reservationId).populate('user', 'displayName').exec(function (err, reservation) {
    ...
    sendMail(reservation, template, content, subject, contact, res);
  });
};
...
function sendMail(reservation, template, content, subject, contact, res){
